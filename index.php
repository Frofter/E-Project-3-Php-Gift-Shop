                ...
                <div class="col s12 m4">
                    <div class="card hoverable animated slideInUp wow">
                        <div class="card-image">
                            <a href="product.php?id=<?= $id_best;  ?>"><img height="250px" src="products/<?= $thumbnail_best; ?>"></a>
...
<div class="container-fluid center-align categories">
    <a href="category.php?id=1" class="button-rounded btn-large waves-effect waves-light">Categories</a>
        ...
        <div class="row">
            ...
            ?>
                    ...
                    <div class="col s12 m4">
                        <div class="card hoverable animated slideInUp wow">
                            <div class="card">
                                <a href="category.php?id=<?= $id_category; ?>"><span class="card-title black-text"><?= $name_category; ?></span></a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col s12 m6">
                ...
                <p class="animated slideInUp wow">We serve in different kinds of products. We try to implement the best possible things that you can buy
                    in cheap price. We care for our customers like our family  </p>
            </div>
...
<div class="container contact" id="contact">
    <div class="row">
        <form action="" method="post" id="email_form" class="col s12 animated slideInUp wow">
